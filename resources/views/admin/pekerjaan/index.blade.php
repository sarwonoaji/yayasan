...
<div class="mb-2">
    ...
    <div class="mt-3 flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
        <div class="flex gap-2">
            <a href="{{ route('admin.pekerjaan.create') }}" class="bg-emerald-600 text-white px-4 py-2 rounded inline-flex items-center gap-2">
...
@include('admin.pekerjaan.partials.table')
